...
const bridge: Bridge = {
  ...
  speakToMp3:input=>ipcRenderer.invoke('nix:speak-mp3',input),
  mp3Export:()=>ipcRenderer.invoke('nix:mp3-export'),
  setMp3Export:enabled=>ipcRenderer.invoke('nix:set-mp3-export',enabled),
  setupXtts:()=>ipcRenderer.invoke('nix:setup-xtts'),
  trainVoice:input=>ipcRenderer.invoke('nix:train-voice',input),
  listVoices:()=>ipcRenderer.invoke('nix:list-voices'),
  deleteVoice:id=>ipcRenderer.invoke('nix:delete-voice',id),
  setVoiceProfile:id=>ipcRenderer.invoke('nix:set-voice-profile',id),
  voiceProfile:()=>ipcRenderer.invoke('nix:voice-profile'),
  setVoicePreset:preset=>ipcRenderer.invoke('nix:set-voice-preset',preset),
  voicePreset:()=>ipcRenderer.invoke('nix:voice-preset'),
  ...
  attachChatFiles: () => ipcRenderer.invoke('nix:chat-attachments'),
